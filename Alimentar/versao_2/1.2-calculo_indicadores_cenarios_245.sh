...
###############################################################################
# SCRIPT: calculo_indicadores_cenarios_245.sh
# DESCRIÇÃO: Calcula indicadores climáticos de precipitação para cenário SSP2-4.5
# PERÍODO: 2068-2088
# MODELO: NorESM2-MM
# SAÍDAS:
...
SWL='2'
SSP='SSP245'
MODEL='NorESM2-MM-pr-ssp245'

# Caminhos de entrada/saída
PATH_IN="/home/usuario/Downloads/NC/CLIMBra/pr/ssp245/$MODEL.nc"
